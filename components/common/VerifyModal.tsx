...
export default function VerifyOTPModal({
  ...
  return (
    ...
    <>
      <div className="min-h-screen hidden md:flex fixed inset-0 z-[9999] bg-black/40 items-center justify-center overscroll-none modal">
      ...
      {/* mobile version */}
      <div className="fixed inset-0 z-[9999] bottom-16 sm:hidden modal">
        <div
